...
public class ScopeStorageActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_v10_scope_storage);
        ...
        btn_get_picture_from_album.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(ScopeStorageActivity.this, AlbumRecyclerActivity.class);
                ...
                try {
                    ...
                    if (is != null){
                        ...
                        runOnUiThread(new Runnable() {
                            @Override
                            public void run() {
                                Toast.makeText(ScopeStorageActivity.this, "Copy file into external files succeeded.", Toast.LENGTH_LONG).show();
                            }
                        });
                    }
                } catch (Exception e) {
                    ...
                    if (connection.getResponseCode() == 200){
                        ...
                        if (is != null && os != null){
                            ...
                            runOnUiThread(new Runnable() {
                                @Override
                                public void run() {
                                    Toast.makeText(ScopeStorageActivity.this, "Android Q download file succeeded.", Toast.LENGTH_SHORT).show();
                                }
                            });
                        }
                    }
